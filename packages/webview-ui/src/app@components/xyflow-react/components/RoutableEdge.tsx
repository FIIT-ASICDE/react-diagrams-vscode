...
export default function RoutableEdge({ id, source, target, style, label, data: { pathPoints, labelPos, minPoints = 1 } = {}, ...props }: RoutableEdgeProps) {
	...
	return (
		<>
			...
			{label && (
				<EdgeLabelRenderer>
					<div className="min-w-10 text-center absolute rounded border truncate border-(--vscode-widget-border) p-1 leading-none text-[11px] text-(--vscode-foreground) shadow-sm"
						style={{
