  ...
  return (
    <>
      ...
      {label && (
        <EdgeLabelRenderer>
          <div
            className="pointer-events-none absolute rounded border border-(--vscode-widget-border) bg-(--vscode-editor-background) px-1.5 py-0.5 text-[11px] text-(--vscode-foreground) shadow-sm z-50"
            style={{
