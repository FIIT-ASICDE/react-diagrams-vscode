...
export default function RoomBooking() {
  ...
  const bookDisabled = busy || status === "confirmed" || status === "error";
    ...
    <div style={{ maxWidth: 580, margin: "0 auto", padding: "32px 18px", fontFamily: "Georgia, serif", color: "#1a1a1a" }}>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 16 }}>
        <button
          ...
          style={{ flex: 1, padding: "11px 0", borderRadius: 8, border: "none", background: bookDisabled ? "#e5e5e5" : "#1a1a1a", color: bookDisabled ? "#999" : "#fff", fontWeight: 700, fontSize: 14, cursor: bookDisabled ? "not-allowed" : "pointer" }}
        >
