...
import { parseFile, resetIdCounter, analyzePropsUsage, extractEnhancedContextUsage, buildScopeMap, ParsedComponent, JsxChildInfo, JsxPropBundleInfo } from './file-parser';
import type {
  ParseOptions,
  ParseResult,
  StateFlowGraph,
