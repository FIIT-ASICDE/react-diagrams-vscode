...
export function parseReactComponent(reactComponent: string, stateFlowOptions?: StateGraphOptions & { rootPath?: string, knownStateVariableHooks?: string[], knownRefVariableHooks?: string[] }): StateDiagram {
	...
	try {
		...
		const stateVariables = collectStateVariables(component, sourceFile, stateFlowOptions?.knownStateVariableHooks, stateFlowOptions?.knownRefVariableHooks);
